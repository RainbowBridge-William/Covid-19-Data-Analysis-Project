...
To do the data analysis, I first calculate the new cases of each state on most recent date. Then calculating the ratio with each state population to get the rate of cases. Lastly compare the rate of cases with percent of vaccination.
